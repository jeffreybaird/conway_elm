...
var _user$project$Type$Model = F2(
	function (a, b) {
		return {time: a, grid: b};
	});
var _user$project$Type$Cell = F3(
	function (a, b, c) {
		return {position: a, alive: b, neighbors: c};
	});
var _user$project$Type$World = F3(
	function (a, b, c) {
		return {time: a, grid: b, seed: c};
	});
var _user$project$Type$Step = {ctor: 'Step'};
var _user$project$Type$Reset = {ctor: 'Reset'};
var _user$project$Type$RandN = function (a) {
	return {ctor: 'RandN', _0: a};
};
var _user$project$Type$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Type$Alive = {ctor: 'Alive'};
var _user$project$Type$Dead = {ctor: 'Dead'};

var _user$project$Model$addRowToGrid = F2(
	function (grid, row) {
		return {ctor: '::', _0: row, _1: grid};
	});
var _user$project$Model$addCellToRow = F2(
	function (cell, row) {
		return {ctor: '::', _0: cell, _1: row};
	});
var _user$project$Model$findNeighbors = function (position) {
	var _p0 = position;
	var x = _p0._0;
	var y = _p0._1;
	return A2(
		...
		function (_p1) {
			var _p2 = _p1;
			return (_elm_lang$core$Native_Utils.cmp(_p2._0, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(_p2._1, 0) > 0);
		},
		{
			ctor: '::',
...
var _user$project$Model$buildCell = F3(
	function (xPosition, yPosition, status) {
		var newStatus = _elm_lang$core$Native_Utils.eq(status, 1) ? _user$project$Type$Alive : _user$project$Type$Dead;
		return {
			position: {ctor: '_Tuple2', _0: xPosition, _1: yPosition},
			alive: newStatus,
			neighbors: _user$project$Model$findNeighbors(
				{ctor: '_Tuple2', _0: xPosition, _1: yPosition})
		};
	});
var _user$project$Model$recursiveRowBuilder = F5(
	function (xCoord, yCoord, status, seed, tempRow) {
		recursiveRowBuilder:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(xCoord, 0) < 1) {
				return tempRow;
			} else {
				var _p3 = A2(
					_mgold$elm_random_pcg$Random_Pcg$step,
					A2(_mgold$elm_random_pcg$Random_Pcg$int, 1, 2),
					seed);
				var n = _p3._0;
				var nextSeed = _p3._1;
				var _v1 = xCoord - 1,
					...
					_v4 = nextSeed,
					_v5 = A2(
					_user$project$Model$addCellToRow,
					A3(_user$project$Model$buildCell, xCoord, yCoord, status),
					tempRow);
				xCoord = _v1;
				yCoord = _v2;
				status = _v3;
				seed = _v4;
				tempRow = _v5;
				continue recursiveRowBuilder;
			}
		}
	});
var _user$project$Model$buildRow = F4(
	function (length, rowNumber, n, seed) {
		return A5(
			_user$project$Model$recursiveRowBuilder,
			length,
			rowNumber,
			n,
			seed,
...
var _user$project$Model$recursiveGridBuilder = F5(
	function (xCoord, yCoord, n, seed, tempGrid) {
		recursiveGridBuilder:
		while (true) {
			var _p4 = A2(
				_mgold$elm_random_pcg$Random_Pcg$step,
				A2(_mgold$elm_random_pcg$Random_Pcg$int, 1, 2),
				seed);
			var nextStatus = _p4._0;
			var newSeed = _p4._1;
			if (_elm_lang$core$Native_Utils.cmp(yCoord, 0) < 1) {
				return tempGrid;
			} else {
				var _v6 = xCoord,
					_v7 = yCoord - 1,
					...
					_v9 = newSeed,
					_v10 = A2(
					_user$project$Model$addRowToGrid,
					tempGrid,
					A4(_user$project$Model$buildRow, xCoord, yCoord, n, seed));
				xCoord = _v6;
				yCoord = _v7;
				n = _v8;
				seed = _v9;
				tempGrid = _v10;
				continue recursiveGridBuilder;
			}
		}
	});
var _user$project$Model$initSeed = function (n) {
	return _mgold$elm_random_pcg$Random_Pcg$initialSeed(n);
};
var _user$project$Model$buildGridWithSeed = F3(
	function (columns, rows, n) {
		var seed0 = _user$project$Model$initSeed(n);
		var _p5 = A2(
			_mgold$elm_random_pcg$Random_Pcg$step,
			A2(_mgold$elm_random_pcg$Random_Pcg$int, 1, 2),
			seed0);
		...
		var seed1 = _p5._1;
		return A5(
			_user$project$Model$recursiveGridBuilder,
			columns,
			rows,
			status,
			seed1,
...
var _user$project$Model$initialWorld = function () {
	var help = A3(_user$project$Model$buildGridWithSeed, 20, 20, 10);
	return {
		time: 0,
		grid: A3(_user$project$Model$buildGridWithSeed, 20, 20, 10),
		seed: 1
	};
}();
var _user$project$Model$init = {ctor: '_Tuple2', _0: _user$project$Model$initialWorld, _1: _elm_lang$core$Platform_Cmd$none};

var _user$project$View$makeId = function (position) {
	var _p0 = position;
	var x = _p0._0;
	var y = _p0._1;
	return A2(
...
var _user$project$View$cellColor = function (cell) {
	return _elm_lang$core$Native_Utils.eq(cell.alive, _user$project$Type$Alive) ? 'blue' : 'white';
};
var _user$project$View$makeRect = function (cell) {
	var _p1 = cell.position;
	var x = _p1._0;
	var y = _p1._1;
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			...
			_1: {
				...
				_0: _elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(100 * y)),
				_1: {
					ctor: '::',
...
var _user$project$View$viewRowSvg = function (cells) {
	return A2(_elm_lang$core$List$map, _user$project$View$makeRect, cells);
};
var _user$project$View$buildSvgGrid = F2(
	function (svgGrid, oldGrid) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
				function (x, y) {
			...
			svgGrid,
			A2(_elm_lang$core$List$map, _user$project$View$viewRowSvg, oldGrid));
	});
var _user$project$View$viewGridSvg = function (grid) {
	var height = _elm_lang$core$Basics$toString(
		(_elm_lang$core$List$length(grid) * 100) + 100);
	var svgGrid = A2(
		_user$project$View$buildSvgGrid,
		{ctor: '[]'},
		grid);
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(height),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Type$Reset),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Type$Step),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$View$view = function (model) {
	return _user$project$View$viewGridSvg(model.grid);
};

var _user$project$Update$neighborCells = F2(
	function (position, grid) {
		var neighbors = _user$project$Model$findNeighbors(position);
		var parseRow = function (row) {
			return A2(
				_elm_lang$core$List$filter,
				function (c) {
					return A2(_elm_lang$core$List$member, c.position, neighbors);
				},
				row);
		};
		return A3(
			...
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, parseRow, grid));
	});
var _user$project$Update$statusBasedOnNeighbors = F2(
	function (currentCell, cells) {
		var liveNeighbors = A2(
			_elm_lang$core$List$filter,
			function (c) {
				return _elm_lang$core$Native_Utils.eq(c.alive, _user$project$Type$Alive);
			},
			cells);
		var neighbors = A2(
			_elm_lang$core$List$map,
			...
			cells);
		var status = currentCell.alive;
		var position = currentCell.position;
		return (_elm_lang$core$Native_Utils.eq(status, _user$project$Type$Dead) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(liveNeighbors),
			3)) ? _user$project$Type$Alive : ((_elm_lang$core$Native_Utils.eq(status, _user$project$Type$Alive) && (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(liveNeighbors),
			2) < 0)) ? _user$project$Type$Dead : ((_elm_lang$core$Native_Utils.eq(status, _user$project$Type$Alive) && (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(liveNeighbors),
			2) || _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(liveNeighbors),
			3))) ? _user$project$Type$Alive : ((_elm_lang$core$Native_Utils.eq(status, _user$project$Type$Alive) && (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(liveNeighbors),
			3) > 0)) ? _user$project$Type$Dead : _user$project$Type$Dead)));
	});
var _user$project$Update$toggleCell = F2(
	function (grid, cell) {
		var newLabel = A2(
			_user$project$Update$statusBasedOnNeighbors,
			cell,
			A2(_user$project$Update$neighborCells, cell.position, grid));
		return _elm_lang$core$Native_Utils.update(
			cell,
			{alive: newLabel});
	});
var _user$project$Update$toggleRow = F2(
	function (grid, row) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Update$toggleCell(grid),
			row);
	});
var _user$project$Update$toggleGrid = function (grid) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Update$toggleRow(grid),
		grid);
};
		...
		switch (_p0.ctor) {
			case 'Tick':
				var newModel = _elm_lang$core$Native_Utils.update(
					...
					{
						time: _p0._0,
						grid: _user$project$Update$toggleGrid(world.grid)
					});
			...
			case 'Reset':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$Type$RandN,
						A2(_elm_lang$core$Random$int, 1, 10021121))
				};
			case 'RandN':
				var newModel = _elm_lang$core$Native_Utils.update(
					world,
					{
						grid: A3(_user$project$Model$buildGridWithSeed, 20, 20, _p0._0)
					});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var newModel = _elm_lang$core$Native_Utils.update(
...
var _user$project$Subscription$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 2, _user$project$Type$Tick);
};

var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Subscription$subscriptions})();
